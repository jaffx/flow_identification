...
def resnet1d18(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return ResNet1d(BasicBlock1d, [2, 2, 2, 2], num_classes=num_classes, include_top=include_top)

def resnet1d34(num_classes=4, include_top=True):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return ResNet1d(BasicBlock1d, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top)


def resnet1d50(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet50-19c8e357.pth
    return ResNet1d(Bottleneck1d, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top)


def resnet1d101(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet101-5d3b4d8f.pth
    return ResNet1d(Bottleneck1d, [3, 4, 23, 3], num_classes=num_classes, include_top=include_top)


def resnext1d50_32x4d(num_classes=1000, include_top=True):
