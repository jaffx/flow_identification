...
function.addNet("MSFINet-FullTrunk", multiSource.MSNetWithFullTrunk, "多源网络，使用<全主干>融合")
function.addNet("MSFINet-HalfBranch", multiSource.MSNetWithHalfBranch, "多源网络，使用<半分支>融合")
